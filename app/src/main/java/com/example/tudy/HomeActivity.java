...
public class HomeActivity extends AppCompatActivity {
 ...
 public   TextView link;
    ...
    public static TextView TOTAL_TEXTVIEW;
   ...
   static int counter = 0;
    ...
    private void updateUI(int x) {
        // Perform UI updates here, for example, update the counter or any other UI elements
        TOTAL_TEXTVIEW.setText(String.valueOf(x + " tasks"));
    }
    ...
    private void initializeVariables() {
        ...
        TOTAL_TEXTVIEW = findViewById(R.id.TOTAL_TASK_TEXTVIEW);
